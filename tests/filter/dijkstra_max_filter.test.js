...
import DijkstraMaxFilter from "../../src/parserLib/Graph/Filter/Tree/Dijkstra/DijkstraMaxFilter";

test("dijkstraMaxFilterTest", async () => {
	...
	const dijkstraFilter = new DijkstraMaxFilter({
